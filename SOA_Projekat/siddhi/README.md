...
```
docker build -t wso2-tooling-deployment-workspace-analytics-1-0-0 .
```
...
```
docker run -it -p 9090:9090 -p 9443:9443 -p 8006:8006  wso2-tooling-deployment-workspace-analytics-1-0-0
```
